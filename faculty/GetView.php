...
if($type=="view"){
...
}else if($type=="notGivenList"){

    echo "<h3 class='w3-blue w3-padding'>Students Who Have NOT Given Graduate Exit  - $branch - $batch batch</h3>";
    ...
    $sql = "
        ...
        LEFT JOIN ges g
            ON LEFT(g.rollnumber, 10) = LEFT(l.email, 10)
        WHERE LEFT(l.email, 2) = '$batch'
        AND l.branch = '$branch'
        AND g.rollnumber IS NULL
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "<tr><td colspan='4'>All students have given feedback</td></tr>";
    }
