...
include '../dbcon.php';
$batch = $_POST['batch'];
echo "<h2><b>$batch</b></h2>";
$sql1 = "select g.overall as a,count(g.rollnumber)as b from ges g,student s  where g.rollnumber=s.rollnumber and s.batch='$batch' group by overall ";
$sql2 = "select g.training_placement as tp,count(g.rollnumber)as c from ges g ,student s where g.rollnumber=s.rollnumber and s.batch='$batch' group by training_placement;";
