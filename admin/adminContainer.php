...
<nav class="w3-sidebar w3-fixed  w3-bar-block w3-collapse  w3-card w3-light-grey" style="z-index:13;width:250px;" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-teal" href="adminDashboard.php">Dashboard</a>
  ...
  <div>
    <a class="w3-bar-item w3-button" onclick="myAccordion('demo')" href="javascript:void(0)">Property <i class="fa fa-caret-down"></i></a>
    <div id="demo" class="w3-hide">
      <a class="w3-bar-item w3-button" href="general.php">General</a>
      <a class="w3-bar-item w3-button" href="characteristics.php">Characteristics</a>
      <a class="w3-bar-item w3-button" href="specifications.php">Specifications</a>
    </div>
  </div>
  <div>
